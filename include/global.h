/****************************************************************************
    ...
    $Id: GLOBAL.H,v 1.88 2011/06/30 08:06:54 R.Dietzsch Exp $
...
#define _DEV_TASKING_TC_		0x00000021L     //                  Tasking for Infineon TriCore
#define _DEV_GNUC_CODE_RED_     0x00000020L     //                  GNU Compiler gcc for ARM from Code Red
#define _DEV_MPLAB_C32_         0x0000001FL     //                  MPLAB C32 for Microchip PIC32MX series
...
#define _DEV_GNU_MPC5X5_        (_DEV_BIT32_ | _DEV_GNUC_MPC5X5| _DEV_BIGEND_ | _DEV_64BIT_SUPPORT_ | _DEV_COMMA_EXT_ | _DEV_ALIGNMENT_4_)
...
#define _DEV_GNU_ARM7_          (_DEV_BIT32_ | _DEV_GNUC_ARM7_                | _DEV_64BIT_SUPPORT_ | _DEV_COMMA_EXT_ | _DEV_ONLY_INT_MAIN_ | _DEV_ALIGNMENT_4_)
#define _DEV_GNU_CODE_RED_      (_DEV_BIT32_ | _DEV_GNUC_CODE_RED_            | _DEV_64BIT_SUPPORT_ | _DEV_COMMA_EXT_ | _DEV_ONLY_INT_MAIN_)
...
#define _DEV_MCW_MCF5XXX_       (_DEV_BIT32_ | _DEV_METROWERKS_CW_            | _DEV_ALIGNMENT_4_) //| _DEV_64BIT_SUPPORT_ | _DEV_COMMA_EXT_)
#define _DEV_GNU_CF5282_        (_DEV_BIT32_ | _DEV_GNUC_CF_   | _DEV_BIGEND_ | _DEV_ALIGNMENT_4_)
#define _DEV_PAR_BECK1X3_       (_DEV_BIT16_ | _DEV_PARADGM_X86)
#define _DEV_GNU_CF548X_        (_DEV_BIT32_ | _DEV_GNUC_CF_   | _DEV_BIGEND_ | _DEV_64BIT_SUPPORT_ | _DEV_COMMA_EXT_ | _DEV_ALIGNMENT_4_)
...
#define _DEV_MPLAB_PIC32_       (_DEV_BIT32_ | _DEV_MPLAB_C32_                | _DEV_64BIT_SUPPORT_ | _DEV_COMMA_EXT_ | _DEV_ONLY_INT_MAIN_ | _DEV_ALIGNMENT_4_)
...
#define _DEV_TASKING_TCXXXX_	(_DEV_BIT32_ | _DEV_TASKING_TC_                | _DEV_ALIGNMENT_4_)
...
//---------------------------------------------------------------------------
//  definitions for MPLAB C32 for PIC32MX series
//---------------------------------------------------------------------------
#elif  defined (__PIC32MX__)

    #define TARGET_SYSTEM   _NO_OS_
    #define DEV_SYSTEM      _DEV_MPLAB_PIC32_
...
//---------------------------------------------------------------------------
//  definitions for Tasking for Infineon TriCore
//---------------------------------------------------------------------------

#elif defined(_TASKING_TRICORE_)

    #define TARGET_SYSTEM   _NO_OS_
    #define DEV_SYSTEM      _DEV_TASKING_TCXXXX_
...
//---------------------------------------------------------------------------
...
#elif defined(__GNUC__) && (defined(__arm__) || defined(__thumb__)) && !defined (__linux__) 
    ...
    #define TARGET_SYSTEM   _NO_OS_
    #define DEV_SYSTEM      _DEV_GNU_CODE_RED_
#else
    #define TARGET_SYSTEM   _NO_OS_
    #define DEV_SYSTEM      _DEV_GNU_ARM7_
#endif
    ...
    #define PUBLIC
        ...
        #define ASSERT(expr)    if (!(expr)) { \
                                   volatile char cDummy = 1; \
                                   TRACE2 ("Assertion failed: " #expr " in line %d of file %s - stop!\n", __LINE__, __FILE__); \
                                   while (cDummy);}
    #else
        #define ASSERT(expr)
    #endif
...
/*$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
Anmerkung von -rs:  Es ist ok LINUX_SYSTEM für alle Linux-Tagets zu definieren,
                    also auch für den PC, da hiermit nur zusätzliche Parameter
                    an den Wrapper übergeben werden, wie auf den Treiber zugegriffen
                    werden soll. Wenn das im Moment für den PC nicht gebraucht wird,
                    dann kann das nur bedeuten, dass der Zugriff auf den Treiber
                    mit hart im Sourcecode vorgegebenen Parametern erfolgt, also
                    eigentlich unschön bzw. sogar falsch gehandhabt wird.
...
/*      #if defined (GNU_CF5282)                        !!! <--- use this !!! (r.d. commented out for compatibilty reason)
            #define DEV_SYSTEM      _DEV_GNU_CF5282_
        #elif defined (GNU_CF548X)
            #define DEV_SYSTEM      _DEV_GNU_CF548X_
        #elif defined (GNU_MIPSEL)*/
        #if defined (GNU_MIPSEL)
            #define DEV_SYSTEM      _DEV_GNU_MIPSEL_
        #else
...
//---------------------------------------------------------------------------
#elif defined(__MWERKS__) && __MWERKS__
...
//---------------------------------------------------------------------------
    ...
    #define LARGE
      ...
      //#define QWORD long long int // MSVC .NET can use "long long int" too (like GNU)
        ...
        // Note: When compiler/WinCE is able to work with 64 bit variables _DEV_64BIT_SUPPORT_ should be defined too in DEV_SYSTEM.
    #endif
    #endif
...
// but a string, which exactly names the mistake.
    ...
    #define MAKE_CONST_INTEL_VALUE(_value_)     _value_
    #define MAKE_CONST_MOTOROLA_VALUE(_value_)  ((((DWORD)(_value_)&0x000000FF)<<24)|((((DWORD)(_value_)&0x00FF0000)<<8))|((((DWORD)(_value_)&0x0000FF00)>>8))|(((DWORD)(_value_)&0xFF000000)>>24))

#else

    #define MAKE_CONST_INTEL_VALUE(_value_)     ((((DWORD)(_value_)&0x000000FF)<<24)|((((DWORD)(_value_)&0x00FF0000)<<8))|((((DWORD)(_value_)&0x0000FF00)>>8))|(((DWORD)(_value_)&0xFF000000)>>24))
    #define MAKE_CONST_MOTOROLA_VALUE(_value_)  _value_
