/****************************************************************************
  ...
  -------------------------------------------------------------------------
                ...
                $Revision: 1.26 $  $Date: 2010/09/02 07:44:24 $
...
// if more than one instance then use this macros
    ...
    #define CCM_DECL_INSTANCE_HDL_LOCAL             tCopInstanceHdl InstanceHandle;
    ...
    #define CCM_GET_FREE_INSTANCE_AND_HDL()         pInstance = CcmGetFreeInstanceAndHandle (pInstanceHandle); \
                                                    DEBUG_ASSERT0 (DEBUG_LVL_ALWAYS, *pInstanceHandle != CCM_ILLINSTANCE_HDL, "ERROR: no free instance!"); \
    ...
    #define CCM_CHECK_INSTANCE_VALID()              if ((pInstance == NULL) || \
                                                        (pInstance->m_InstState != kStateUsed)) \
                                                        {return (kCopIllegalInstance);}

    #define CCM_GET_FREE_INSTANCE_PTR()             pInstance = GetFreeInstance (); \
                                                    DEBUG_ASSERT0 (DEBUG_LVL_ALWAYS, pInstance != CCM_ILLINSTANCE, "ERROR: no free instance!");
    ...
    #define MCO_INSTANCE_PTR_ORNULL                 pInstance
    ...
    #define MCO_CHECK_INSTANCE_STATE()              DEBUG_ASSERT0 (DEBUG_LVL_ALWAYS, pInstance != NULL, "ERROR: invalid instance parameter!"); \
                                                    DEBUG_ASSERT0 (DEBUG_LVL_ALWAYS, ((tCopPtrInstance)pInstance)->m_InstState == kStateUsed, "ERROR: instance not in use!");
    ...
    #define MCO_CHECK_PTR_INSTANCE_PTR()            DEBUG_ASSERT0 (DEBUG_LVL_ALWAYS, pInstancePtr != NULL, "ERROR: invalid instance pointer!");
...
// instance is to be used.
    ...
    #define CCM_DECL_INSTANCE_HDL_LOCAL
    ...
    #define CCM_CHECK_INSTANCE_VALID()              if (CCM_INST_ENTRY.m_CcmInitParam.m_fpObdInitRam == NULL) \
                                                        {return (kCopIllegalInstance);}
...
// This class of macros are used by CANopen internal function to point to one instance.
    ...
    #define MCO_INSTANCE_PTR_ORNULL                 NULL
